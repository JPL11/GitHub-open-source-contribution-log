...
**Student:** Jacky Li
**Issue:** [GitHub Issue #3244](https://github.com/WebAssembly/binaryen/issues/3244)
...
I chose this issue because it connects directly to the kind of low-level systems thinking I've developed through both coursework and hands-on projects. Working with assembly and microcontrollers has given me a strong intuition for how data moves between hardware and software layers — and kernel-userspace transfer via `ioctl` sits right in that same space, just at a different level of the stack.
